            ...
            <div className="flex-1">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-muted-foreground mb-2">SKU: {product.sku}</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Có thể bán</p>
                  <p className="text-2xl font-bold text-green-600">{product.availableStock}</p>
                </div>
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Đã đặt trước</p>
                  <p className="text-2xl font-bold text-orange-600">{product.reservedStock}</p>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Lợi nhuận</p>
                  <p className="text-2xl font-bold text-purple-600">{product.profitMargin}%</p>
                </div>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Tồn kho tối thiểu</p>
                  <p className="text-lg font-semibold">{product.minStock}</p>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Tồn kho tối đa</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-xl font-bold text-blue-600">{formatPrice(product.costPrice)}</p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Giá bán</p>
                  <p className="text-xl font-bold text-green-600">{formatPrice(product.sellingPrice)}</p>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Lợi nhuận</p>
                  <p className="text-xl font-bold text-purple-600">{formatPrice(product.profit)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Vị trí kho</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{product.barcode || 'Không có'}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
