...
import { Store, Upload, MessageCircle, Wallet, BarChart3, Droplet } from 'lucide-react'
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom duration-1000">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Nền tảng quản lý bán sỉ chuyên nghiệp với đầy đủ công cụ cần thiết. 
          ...
          {/* Seller System Card */}
          <div className="max-w-2xl mx-auto mt-12 animate-in fade-in slide-in-from-bottom duration-1000 delay-300">
