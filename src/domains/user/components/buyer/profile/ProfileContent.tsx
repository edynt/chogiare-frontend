...
export function ProfileContent() {
  ...
  useEffect(() => {
    if (
      tabFromUrl &&
      ['profile', 'orders', 'settings', 'addresses'].includes(tabFromUrl)
    ) {
  ...
  const handleTabChange = (
    tab: 'profile' | 'orders' | 'settings' | 'addresses'
  ) => {
    if (tab === 'addresses') {
      navigate('/addresses')
      return
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    value={
                      isEditingProfile ? profileFormData.fullName : profile.name
                    }
              ...
              <div className="space-y-4">
                ...
                {ordersData.total > ordersData.items.length && (
                  <div className="text-center pt-4">
                    <Button variant="outline">Xem thêm đơn hàng</Button>
                  </div>
                )}
              </div>
            ) : (
