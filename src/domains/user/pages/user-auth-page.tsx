...
import { UserLoginForm } from '@user/components/auth/user-login-form'
 ...
 * Bright, marketplace-themed authentication interface for regular users
 * Features:
 * - Colorful, engaging design
 * - Multiple routes: login, register, forgot-password, reset-password
 * - Marketing elements and benefits
...
export default function UserAuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center">
      ...
      />
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom duration-700 p-4">
        {/* Header with Logo */}
        <div className="text-center">
          <Link
            to="/"
            className="flex items-center justify-center mb-4 hover:opacity-80 hover:scale-105 transition-all duration-300"
          >
          ...
          <h1 className="text-3xl font-bold text-primary animate-in fade-in duration-1000 delay-200">
            {APP_NAME}
          </h1>
          <p className="text-muted-foreground animate-in fade-in duration-1000 delay-300">
            Nền tảng rao bán uy tín
          </p>
        </div>
