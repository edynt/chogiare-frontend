        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Chợ Giá Rẻ cam kết bảo vệ quyền riêng tư và thông tin cá nhân của
              bạn. Chính sách bảo mật này giải thích cách chúng tôi thu thập, sử
              dụng, lưu trữ và bảo vệ thông tin của bạn khi bạn sử dụng dịch vụ
              của chúng tôi.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Chúng tôi <strong>không bán</strong> thông tin cá nhân của bạn cho
              bên thứ ba. Thông tin chỉ được chia sẻ trong các trường hợp sau:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground mt-2">
              <li>
                Với người bán/người mua để hoàn tất giao dịch (tên, địa chỉ giao
                hàng, số điện thoại).
              </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              hợp để bảo vệ thông tin của bạn, bao gồm:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground mt-2">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              chọn và cải thiện trải nghiệm sử dụng. Bạn có thể tắt cookie trong
              cài đặt trình duyệt, tuy nhiên một số tính năng có thể bị ảnh
              hưởng.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Thông tin của bạn được lưu trữ trong thời gian bạn duy trì tài
              khoản. Sau khi xóa tài khoản, dữ liệu sẽ được xóa hoặc ẩn danh hóa
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">
              9. Tự động xóa tài khoản không hoạt động
            </h2>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Để bảo vệ dữ liệu và tối ưu hệ thống, tài khoản không đăng nhập
              trong vòng <strong>180 ngày (6 tháng)</strong> sẽ bị tự động xóa
              vĩnh viễn cùng toàn bộ dữ liệu liên quan, bao gồm:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground mt-2">
            ...
            <p className="text-muted-foreground leading-relaxed mt-3">
              Hệ thống sẽ kiểm tra tự động hàng ngày. Để duy trì tài khoản, bạn
              chỉ cần đăng nhập ít nhất một lần trong vòng 180 ngày. Sau khi tài
              khoản bị xóa, dữ liệu <strong>không thể khôi phục</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Mọi thay đổi quan trọng sẽ được thông báo qua email hoặc trên
              website.
            </p>
          </section>
