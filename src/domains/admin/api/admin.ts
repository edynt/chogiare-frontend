...
export const adminApi = {
  ...
  getAnalyticsOverview: async (
    ...
    return
    try {
      const response = await apiClient.get<ApiResponse<AnalyticsOverviewStats>>(
  ...
  getAnalyticsTopProducts: async (
    ...
    try {
      const response = await apiClient.get<ApiResponse<AnalyticsTopProduct[]>>(
  ...
  getCategoryStats: async (): Promise<CategoryStat[]> => {
    try {
      const response = await apiClient.get<ApiResponse<CategoryStat[]>>(
  ...
  getPaymentStats: async (): Promise<AdminPaymentStats> => {
    try {
      const response = await apiClient.get<ApiResponse<AdminPaymentStats>>(
  ...
  getModerationProducts: async (
    params?: QueryModerationProductsParams
  ): Promise<ModerationProductListResponse> => {
    try {
      const response = await apiClient.get<
        ApiResponse<ModerationProductListResponse>
      >('/admin/moderation/products', { params })
      return response.data.data
    } catch (error) {
      return handleApiError(error, {
        items: [],
  ...
  approveProduct: async (id: string): Promise<ModerationProduct> => {
    const response = await apiClient.put<ApiResponse<ModerationProduct>>(
      `/admin/moderation/products/${id}/approve`
    )
    return response.data.data
  },
  ...
  rejectProduct: async (
    ...
    const response = await apiClient.put<ApiResponse<ModerationProduct>>(
      `/admin/moderation/products/${id}/reject`,
      { reason }
    )
    return response.data.data
  },
  ...
  bulkApproveProducts: async (
    ...
    const response = await apiClient.post<ApiResponse<{ count: number }>>(
      '/admin/moderation/products/bulk-approve',
      { productIds }
    )
    return response.data.data
  },

  bulkRejectProducts: async (
    productIds: string[],
    reason?: string
  ): Promise<{ count: number }> => {
    const response = await apiClient.post<ApiResponse<{ count: number }>>(
      '/admin/moderation/products/bulk-reject',
      { productIds, reason }
    )
    return response.data.data
  },
  ...
  getPackageStats: async (): Promise<PackageStats> => {
    try {
      const response = await apiClient.get<ApiResponse<PackageStats>>(
  ...
  getContents: async (
    ...
    try {
      const response = await apiClient.get<ApiResponse<ContentListResponse>>(
        '/admin/contents',
        { params }
      )
      return response.data.data
  ...
  updateContent: async (
    ...
    const response = await apiClient.put<ApiResponse<ContentItem>>(
      `/admin/contents/${id}`,
      data
    )
    return response.data.data
  ...
  getCategoryDistribution: async (): Promise<CategoryDistribution[]> => {
    try {
      const response = await apiClient.get<ApiResponse<CategoryDistribution[]>>(
  ...
  getTopProducts: async (params?: {
    ...
    try {
      const response = await apiClient.get<ApiResponse<TopProductReport[]>>(
  ...
  getTopSellersReport: async (params?: {
    limit?: number
    timeRange?: string
  }): Promise<TopSellerReport[]> => {
    try {
      const response = await apiClient.get<ApiResponse<TopSellerReport[]>>(
  ...
  createNotification: async (
    ...
    const response = await apiClient.post<ApiResponse<AdminNotification>>(
      '/admin/notifications',
      data
    )
    return response.data.data
  ...
  getHeaderNotifications: async (
    limit?: number
  ): Promise<AdminHeaderNotificationsResponse> => {
    try {
      const response = await apiClient.get<
        ApiResponse<AdminHeaderNotificationsResponse>
      >('/admin/dashboard/header-notifications', {
        params: { limit },
      })
      return response.data.data
    } catch (error) {
  ...
  getSystemSettings: async (): Promise<SystemSettings> => {
    try {
      const response =
        await apiClient.get<ApiResponse<SystemSettings>>('/admin/settings')
      return response.data.data
    } catch (error) {
      return handleApiError(error, {
  ...
  updateSettingsByCategory: async <T>(
    category: string,
    settings: T
  ): Promise<T> => {
  ...
  // Category APIs
  getCategories: async (
    params?: QueryAdminCategoriesParams
