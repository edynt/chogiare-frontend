  ...
  const getProductBadges = () => {
    ...
    if ((product.viewCount || 0) > 1000) {
      badges.push({
        ...
        className:
          'bg-gradient-to-r from-red-500 to-orange-500 text-white border-0 animate-pulse',
      })
    }
        ...
        <div className="relative aspect-[4/3] overflow-hidden bg-muted">
          ...
          <div className="absolute top-2 left-2 flex flex-col gap-1.5 z-10">
            ...
            {product.stock <= 5 && product.stock > 0 && (
              <Badge className="text-xs font-bold shadow-lg bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0">
                SẮP HẾT
              </Badge>
            )}
            {/* Product Badges */}
          ...
          <div className="flex items-center justify-between text-xs pt-2 border-t border-border/50 gap-2">
            <div className="flex items-center gap-2 min-w-0 flex-1">
              ...
              <div className="flex items-center gap-1 text-muted-foreground whitespace-nowrap">
                ...
                <span>
                  {(product.viewCount || 0) * 2 + product.reviewCount * 5}
                </span>
              </div>
            </div>
            {/* Stock */}
