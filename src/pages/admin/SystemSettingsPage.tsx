            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={settings.user.lockoutDuration}
                    disabled={!isEditing}
                    className="mt-1"
                  />
                </div>
              ...
              {renderSettingField(
                ...
                <Switch
                  checked={settings.user.requireUppercase}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                ...
                <Switch
                  checked={settings.user.requireNumber}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                ...
                <Switch
                  checked={settings.user.requireSpecialChar}
                  disabled={!isEditing}
                />
              )}
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Session timeout (giờ)</Label>
                  <Input
                    type="number"
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={settings.user.rememberMeDuration}
                    disabled={!isEditing}
                    className="mt-1"
                  />
                </div>
          ...
          <Card>
            ...
            <CardContent>
              {renderSettingField(
                ...
                <Switch
                  checked={settings.user.twoFactorAuth}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                ...
                <Switch
                  checked={settings.user.profileCompletion}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                ...
                <Switch
                  checked={settings.user.phoneRequired}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                'Xác minh danh tính',
                'Yêu cầu upload CMND/CCCD',
                <Switch
                  checked={settings.user.identityVerification}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                'Xác minh người bán',
                'Yêu cầu xác minh để bán hàng',
                <Switch
                  checked={settings.user.sellerVerification}
                  disabled={!isEditing}
                />
              )}
              <div className="pt-4 border-t mt-4">
                <h4 className="font-medium text-sm mb-3">Thông báo mặc định</h4>
                {renderSettingField(
                  'Email',
                ...
                {renderSettingField(
                  ...
                  <Switch
                    checked={settings.user.smsNotifications}
                    disabled={!isEditing}
                  />
                )}
                {renderSettingField(
                  'Push',
                  'Thông báo đẩy trên trình duyệt/app',
                  <Switch
                    checked={settings.user.pushNotifications}
                    disabled={!isEditing}
                  />
                )}
              </div>
            ...
            <CardContent>
              ...
              <div className="pt-4 space-y-4">
                <div>
                  ...
                  <Select disabled={!isEditing} value={settings.cache.driver}>
                    <SelectTrigger className="mt-1">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                {settings.cache.driver === 'redis' && (
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        value={settings.cache.redisHost}
                        disabled={!isEditing}
                        className="mt-1"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        type="number"
                        value={settings.cache.redisPort}
                        disabled={!isEditing}
                        className="mt-1"
                      />
                    </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              {renderSettingField(
                ...
                'Cache response API',
                <Switch
                  checked={settings.cache.apiCache}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                ...
                <Switch
                  checked={settings.cache.queryCache}
                  disabled={!isEditing}
                />
              )}
              {renderSettingField(
                ...
                <Switch
                  checked={settings.cache.staticCache}
                  disabled={!isEditing}
                />
              )}
              ...
              <div className="pt-4 border-t mt-4">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">{systemHealth.cacheHitRate}%</p>
                  </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {Object.entries(settings.social.socialLogin).map(([provider, enabled]) => (
                  <div key={provider} className="flex items-center justify-between py-3 border-b last:border-b-0">
                    <div className="flex items-center gap-3">
                      {provider === 'facebook' && <Facebook className="h-5 w-5 text-blue-600" />}
                      {provider === 'google' && <Globe className="h-5 w-5 text-red-500" />}
                      {provider === 'apple' && <Smartphone className="h-5 w-5 text-gray-800" />}
                      {provider === 'zalo' && <MessageCircle className="h-5 w-5 text-blue-500" />}
              ...
              <div className="pt-4 border-t mt-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      value={settings.social.googleClientId}
                      disabled={!isEditing}
                      className="mt-1"
                    />
                  </div>
